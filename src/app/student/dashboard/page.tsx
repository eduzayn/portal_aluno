  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6 mb-6 md:mb-8">
        <div className="bg-white p-4 md:p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow transition-all duration-200">
          <div className="flex items-center gap-2 mb-2">
            <BookOpen className="h-5 w-5 text-indigo-600" />
            <h2 className="text-lg font-semibold text-gray-800">Cursos</h2>
          </div>
          <p className="text-2xl md:text-3xl font-bold text-gray-800">{courses.length}</p>
        ...
        <div className="bg-white p-4 md:p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow transition-all duration-200">
          ...
          <p className="text-2xl md:text-3xl font-bold text-gray-800">{student?.certificates.length || 0}</p>
